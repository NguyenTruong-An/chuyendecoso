...
<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
    ...
    <div class="sidebar-shortcuts">
        <div class="sidebar-shortcuts-large">
            <a href="/trang-chu">
                <button class="btn btn-success" style="text-align: center; width: 80px; line-height: 24px; padding: 0; border-width: 4px;" title="Trang chủ">
...
<%--</ul>--%>
    <ul class="nav nav-list">
        <li class="">
            <a href="#" class="dropdown-toggle">
                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="17" fill="currentColor" class="bi bi-building-fill" viewBox="0 0 16 16">
                ...
                <span class="menu-text">Quản Lý Khách Sạn</span>
            </a>
            <b class="arrow"></b>
            <ul class="submenu">
                <li class="">
