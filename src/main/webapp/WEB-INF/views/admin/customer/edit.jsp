        ...
        <div class="col-xs-12">
          ...
          <c:if test="${not empty customerDTO.id}">
            <c:forEach var="item" items="${transactionType}">
              ...
              <c:if test="${item.key =='TGD'}">
                <div class="row">
                  <div class="col-xs-12">
                    <table id="TGD-list" class="table table-striped table-bordered table-hover">
                      <thead>
                      <tr>
                        <th>Ngày tạo</th>
                        <th>Người tạo</th>
                      ...
                      <tbody>
                      <c:forEach var="transaction" items="${TGD}">
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-xs btn-info" onclick="updateTransaction('TGD',${customerDTO.id},${transaction.id},'${transaction.note}')">
