...
public class UserService implements IUserService {
    ...
    @Override
    public List<StaffResponseDTO> loadStaffs(Long id) {
        ...
        List<UserEntity> assignmentStaff = userRepository.findByAssignmentHotelEntities_hotelEntity(hotelEntity);
        for(UserEntity staff : staffList){
            StaffResponseDTO staffResponseDTO = new StaffResponseDTO();
            if(assignmentStaff.contains(staff)){
