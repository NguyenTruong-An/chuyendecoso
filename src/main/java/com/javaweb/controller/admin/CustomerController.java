...
public class CustomerController {
    ...
    public ModelAndView getCustomers(@ModelAttribute("customerSearch") CustomerSearchRequest params,
                                     HttpServletRequest request) {
        ModelAndView view = new ModelAndView("admin/customer/list");
        view.addObject("staffs", userService.getStaffs());
    ...
    public ModelAndView addCustomer(@ModelAttribute("customerDTO") CustomerSearchRequest params){
    ...
    public ModelAndView editBuilding(@PathVariable Long id){
        ...
        List<TransactionEntity> TGD = transactionService.getTransactionByCodeAndCustomerId("TGD",id);
        view.addObject("TGD", TGD);
        return view;
    }
}
